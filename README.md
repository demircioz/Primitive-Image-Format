...
This project was created as part of **SAÉ 3.2 (Semester 3)** at the IUT of Fontainebleau. Its goal is the design and implementation of a proprietary image file format named **PIF (Primitive Image Format)**, as well as the development of a software suite to manipulate it.
...
* **📊 Statistical Analysis**: Precise calculation of the frequency of each color intensity (0-255).
* **🔍 Technical Visualization**: Dynamic display of Huffman trees and generated canonical codes as interactive tables.
* **🔨 Usability**: Uses *JMenuBar*, status bar, and full **Drag & Drop** support to load an image instantly.

### 🖼️ Viewer (Decoder)

* **⚙️ High-Fidelity Decoding**: Bit-by-bit reconstruction of the original image from the PIF archive.
* **⚓ Advanced Navigation**: Interactive rendering system allowing **Centered Zoom** (scroll wheel) and **Panning** (click & drag).
* **😀 Adaptability**: Automatic resizing of the interface based on the resolution of the loaded image.
...
│   ├── Main.java              # Main entry point (Launcher)
│   ├── controllers/           # Stream managers (Converter, Decoder)
│   ├── models/                # Compression logic (Huffman, Readers/Writers)
│   └── views/                 # Swing Interfaces (Frames, Panels, Theme)
│
├── res/                       # Visual resources (Icons, Background)
├── diagrammes/                # UML Diagrams (PlantUML)
├── build/                     # Compiled classes (generated by Make)
├── doc/                       # Javadoc documentation (generated)
├── Makefile                   # Complete project automation
└── *.jar                      # Generated executable archives
...
### 🐧 For Linux / macOS (or Windows with Git Bash)
...
### 🪟 For Windows (Manual Compilation and Execution)
...
### 🐧 On Linux / macOS (or via Makefile)
...
| Name | Profile | Role |
| --- | --- | --- |
| **Canpolat DEMIRCI–ÖZMEN** | [Git](https://grond.iut-fbleau.fr/demircio) | Decoder & UI/UX Design |
...
*BUT2 Computer Science – 2025/2026 – IUT of Fontainebleau (UPEC)*
